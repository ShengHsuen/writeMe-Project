...
import com.mett.writeMe.config.PassthroughFilter;
import com.mett.writeMe.config.WSFilter;

@SpringBootApplication
@ComponentScan(basePackages = {"com.mett.writeMe"})
@EnableAutoConfiguration

@EnableJpaRepositories("com.mett.writeMe.repositories")
@EnableTransactionManagement
@EntityScan(basePackages = "com.mett.writeMe.ejb")
